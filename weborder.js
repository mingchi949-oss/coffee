...
locationInput?.addEventListener("change", () => // Changed to 'change' for select element
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    if (!phone || !location) { // Use the locally defined variables for validation
    ...
    fetch(telegramUrl, requestOptions)
      ...
      .then((data) => {
        if (data.ok) {
          ...
          // Redirect to the pending page to allow checking confirmation
